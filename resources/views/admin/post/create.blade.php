...
@section('content')
    ...
    <div class="container-fluid">
        ...
        @if ($Isposts)
            <form method="POST" action="{{ route('post.update', $Isposts->id) }}">
                @method('PATCH')
                @csrf
                <div class="form-group">
                <label for="formGroupExampleInput">Title</label>
                <input type="text" class="form-control" name="cat_name" value="{{ $Isposts->name }}" id="formGroupExampleInput" placeholder="Example input">
                </div>
